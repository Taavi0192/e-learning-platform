...
const ForgotPassword = () => {
  ...
  const handleEmailSubmit = (e) => {
    ...
    // For demo, just move to next step
    setError("");
    setStep(2);
    startCountdown();
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 h-full">
          ...
          <div className="bg-gradient-to-br from-[#19a4db] to-[#6dc9f1] p-6 lg:p-8 xl:p-10 text-white relative overflow-hidden h-full">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 mb-16">We'll help you recover your account</p>
              
              {/* Password Recovery Steps */}
              <div className="space-y-8 mt-20">
                <div className="flex items-center space-x-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-medium ${step === 1 ? 'bg-white text-[#19a4db]' : 'bg-white/30 text-white'}`}>
                    1
                  </div>
                  <div>
                    <h3 className="font-medium text-lg">Verify Email</h3>
                    <p className="text-sm text-white/70">Enter your registered email</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-medium ${step === 2 ? 'bg-white text-[#19a4db]' : 'bg-white/30 text-white'}`}>
                    2
                  </div>
                  <div>
                    <h3 className="font-medium text-lg">Enter OTP</h3>
                    <p className="text-sm text-white/70">Enter the code sent to your email</p>
                  </div>
                </div>
                
                <div className="flex items-center space-x-4">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-medium ${step === 3 ? 'bg-white text-[#19a4db]' : 'bg-white/30 text-white'}`}>
                    3
                  </div>
                  <div>
                    <h3 className="font-medium text-lg">Create New Password</h3>
                    <p className="text-sm text-white/70">Set a new secure password</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col pt-16 px-4 overflow-y-auto">
            <div className="max-w-lg mx-auto w-full">
              ...
              {step === 2 && (
                <>
                  <h2 className="text-2xl font-bold text-gray-800 mb-1">Verify Your Identity</h2>
              ...
              {step === 3 && (
                <>
                  <h2 className="text-2xl font-bold text-gray-800 mb-1">Create New Password</h2>
                  <p className="text-gray-600 mb-8">Enter a secure password for your account</p>
                  ...
                  <form onSubmit={handlePasswordSubmit} className="space-y-4">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-medium text-gray-800 mb-1">Password tips:</h4>
