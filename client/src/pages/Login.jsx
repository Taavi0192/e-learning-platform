...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Demo login - in a real app would authenticate with a backend
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 h-full">
          ...
          <div className="bg-gradient-to-br from-[#19a4db] to-[#6dc9f1] p-6 lg:p-8 xl:p-10 text-white relative overflow-hidden h-full">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 mb-16">Sign in to continue your learning journey</p>
              ...
              <div className="space-y-6 mt-20">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">Resume where you left off</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">View assignments and grades</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">Collaborate with classmates</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-lg mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <Link to="/forgot-password" className="text-sm text-[#19a4db] hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                </div>
